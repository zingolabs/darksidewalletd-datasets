...
grpcurl -plaintext -d '{ "url" : "http://localhost:8000/expires-inbound-transaction/before_reorg.txt" }' localhost:9067 cash.z.wallet.sdk.rpc.DarksideStreamer/StageBlocks
