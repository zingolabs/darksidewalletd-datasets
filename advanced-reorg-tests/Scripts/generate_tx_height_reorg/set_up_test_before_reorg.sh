...
grpcurl -plaintext -d '{ "url" : "http://localhost:8000/changes-inbound-tx-mined-height/before_reorg.txt" }' localhost:9067 cash.z.wallet.sdk.rpc.DarksideStreamer/StageBlocks
